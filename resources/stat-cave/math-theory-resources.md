...
| Name | Description | Link |
|------|-------------|------|
| Radon Transform | Integral transform used in tomography and inverse problems | [Wikipedia](https://en.wikipedia.org/wiki/Radon_transform) |
| Ramsey Theory | Study of conditions under which order must appear | [Wikipedia](https://en.wikipedia.org/wiki/Ramsey_theory) |
| Random Matrix Theory | Statistical study of eigenvalues of large random matrices | [Wikipedia](https://en.wikipedia.org/wiki/Random_matrix) |
| Random Walk | Mathematical formalization of a path with successive random steps | [Wikipedia](https://en.wikipedia.org/wiki/Random_walk) |
| Range Space | Set of all possible outputs of a function | [Wikipedia](https://en.wikipedia.org/wiki/Image_(mathematics)) |
| Rank of a Matrix | Dimension of the vector space generated by its columns or rows | [Wikipedia](https://en.wikipedia.org/wiki/Rank_(linear_algebra)) |
| Rational Numbers | Numbers expressible as p/q with integers p and q≠0 | [Wikipedia](https://en.wikipedia.org/wiki/Rational_number) |
| Rayleigh Quotient | Ratio involving a matrix and vector, used in eigenvalue problems | [Wikipedia](https://en.wikipedia.org/wiki/Rayleigh_quotient) |
| Real Analysis | Study of real numbers and real-valued sequences and functions | [Wikipedia](https://en.wikipedia.org/wiki/Real_analysis) |
| Real Numbers | Set of all rational and irrational numbers | [Wikipedia](https://en.wikipedia.org/wiki/Real_number) |
| Recurrence Relation | Equation defining a sequence based on preceding terms | [Wikipedia](https://en.wikipedia.org/wiki/Recurrence_relation) |
| Recursive Function | Function defined in terms of itself | [Wikipedia](https://en.wikipedia.org/wiki/Recursion_(mathematics)) |
| Reductive Group | Type of algebraic group in representation theory | [Wikipedia](https://en.wikipedia.org/wiki/Reductive_group) |
| Reflection Group | Group generated by reflections in a Euclidean space | [Wikipedia](https://en.wikipedia.org/wiki/Reflection_group) |
| Regular Graph | Graph where each vertex has the same number of neighbors | [Wikipedia](https://en.wikipedia.org/wiki/Regular_graph) |
| Regularization (Math) | Techniques to prevent overfitting or ill-posedness in inverse problems | [Wikipedia](https://en.wikipedia.org/wiki/Regularization_(mathematics)) |
| Residue Theorem | Complex analysis theorem for evaluating line integrals of analytic functions | [Wikipedia](https://en.wikipedia.org/wiki/Residue_theorem) |
| Resolvent (Operator) | Operator function useful in spectral theory | [Wikipedia](https://en.wikipedia.org/wiki/Resolvent_formalism) |
| Ricci Curvature | Measure of the degree to which geometry deviates from flatness | [Wikipedia](https://en.wikipedia.org/wiki/Ricci_curvature) |
| Riemann Hypothesis | Conjecture on zeros of the Riemann zeta function | [Wikipedia](https://en.wikipedia.org/wiki/Riemann_hypothesis) |
| Riemann Integral | Fundamental definition of the integral of a function | [Wikipedia](https://en.wikipedia.org/wiki/Riemann_integral) |
| Riemann Surface | One-dimensional complex manifold | [Wikipedia](https://en.wikipedia.org/wiki/Riemann_surface) |
| Riesz Representation Theorem | Fundamental theorem in functional analysis | [Wikipedia](https://en.wikipedia.org/wiki/Riesz_representation_theorem) |
| Ring Theory | Study of algebraic structures called rings | [Wikipedia](https://en.wikipedia.org/wiki/Ring_(mathematics)) |
| Root of Unity | Complex number that is an nth root of 1 | [Wikipedia](https://en.wikipedia.org/wiki/Root_of_unity) |
| Root-Finding Algorithms | Numerical methods to find roots of equations | [Wikipedia](https://en.wikipedia.org/wiki/Root-finding_algorithms) |
