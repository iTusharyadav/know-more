...
| Name | Description | Link |
|------|-------------|------|
| Carnegie Mellon Open Learning Initiative: Probability & Statistics | Free interactive course with exercises, quizzes & projects | [Website](https://oli.cmu.edu/courses/probability-statistics-open-free/) |
| Computational Statistics with R | Free online book on applied statistics & simulation techniques in R | [Website](https://cran.r-project.org/doc/contrib/Faraway-PRA.pdf) |
| Confidence Intervals Made Easy (Article) | Beginner-friendly article explaining confidence intervals with visuals | [Article](https://towardsdatascience.com/a-visual-guide-to-confidence-intervals-ecb5e075b9e0) |
| Coursera: Statistics with Python Specialization | Hands-on guided courses on stats using Python (UMich) | [Website](https://www.coursera.org/specializations/statistics-with-python) |
| Cross Validated (StackExchange) | Community Q&A forum for statistics, probability & data analysis | [Website](https://stats.stackexchange.com/) |
